...
function displayNote() {
    ...
    notesObj.forEach(function (element, index) {
        ...
        <div class="card-body">
            ...
            <button id=${index} onclick="deleteNode(this.id)" type="button" class="btn btn-danger">Delete this Note</button>
        </div>
    </div> `
    });
    ...
    if (notesObj.length != 0) {
        ...
        noteselm.innerHTML = `<i>No notes yet! Use the section above to add
